...
namespace App\Services\Contractors\Snap\Jobs;

use App\Services\Contractors\Base\Enums\ChannelsEnum;
use App\Services\Contractors\Snap\Enums\StatusesEnum;
use App\Services\Contractors\Snap\FactoryMethod\OrderProcessor;
...
class FailureHandler implements ShouldQueue
{
    ...
    private function recallWithExceptionHandler(Order $order): void
    {
            try {
                ...
                Log::info('Failed on recalling snap failures : ' . $exception->getMessage());
            }
